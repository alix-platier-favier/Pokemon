...
class Pokemon:
    ...
    def attack_def(self, pokemon2):
        ...
        for i, k in enumerate(version):
            if self.types == k:
                if pokemon2.types == k:
                    s1_attack = "It's not very effective..."
                    s2_attack = "It's not very effective..."
                ...
                if pokemon2.types == version[(i+1)%3]:
                    ...
                    self.defense /=2
                    s1_attack = "It's not very effective..."
                    s2_attack = "It's super effective!"
                ...
                if pokemon2.types == version[(i+2)%3]:
                    ...
                    pokemon2.attack /= 2
                    pokemon2.defense /=2
                    s1_attack = "It's super effective!"
                    s2_attack = "It's not very effective..."

    def fight(self, pokemon2):
                print("------POOKEMON FIGHTING------")
                print(f"\n{self.name}")
